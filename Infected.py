...
#--------------------------------------------------
#IMAGES
titlePic=image.load("titlePic.png")
bigInfectedPic=image.load("bigInfectedPic.png")
infectedPic=image.load("infectedPic.png")
playPic=image.load("playPic.png")
numOfPlayers=image.load("numOfPlayers.png")
player2=image.load("2Player.png")
player3=image.load("3Player.png")
player4=image.load("4Player.png")
rMine=image.load("rMine.png")
gMine=image.load("gMine.png")
bMine=image.load("bMine.png")
yMine=image.load("yMine.png")
rrMine=image.load("rrMine.png")
ggMine=image.load("ggMine.png")
bbMine=image.load("bbMine.png")
yyMine=image.load("yyMine.png")
rrrMine=image.load("rrrMine.png")
gggMine=image.load("gggMine.png")
bbbMine=image.load("bbbMine.png")
yyyMine=image.load("yyyMine.png")
redWin=image.load("redWin.png")
greenWin=image.load("greenWin.png")
blueWin=image.load("blueWin.png")
yellowWin=image.load("yellowWin.png")
returnPic=image.load("returnPic.png")
cornerEx=image.load("cornerEx.png")
edgeEx=image.load("edgeEx.png")
middleEx=image.load("middleEx.png")
cornerText=image.load("cornerText.png")
edgeText=image.load("edgeText.png")
middleText=image.load("middleText.png")
objectiveText=image.load("objectiveText.png")
controlText=image.load("controlText.png")
#--------------------------------------------------
#DICTIONARY
pieceImages={
